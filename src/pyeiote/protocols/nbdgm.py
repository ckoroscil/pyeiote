...
from scapy.all import Ether, IP, UDP, RandShort, NBTDatagram, SMBMailSlot, SMB_Header, SMBNetlogon_Protocol_Response_Header
from . import const
...
class NBDGM(BaseProtocol):
    ...
    def generate_packet(self):
        ...
        return Ether(src=srcmac, dst=dstmac)/\
            IP(src=srcip, dst=dstip, ttl=255)/UDP(sport=sport, dport=dport)/\
